...
This report provides a self-contained overview of known results and the methods
...
A final result I'd like to mention is found in \cite{olmezov-derivative}.
...
I have not read this article yet but I intend to do so in the future. The bound \(\frac{5}{3} \) is promising,
even if it places strong restrictions on the structure of the set \(A\).
...
We can directly apply this to obtain a bound on the additive energy between
a convex set and an arbitrary set.
