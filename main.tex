...
\begin{align*}
    ...
    & = \left( A(2) - A(1) \right) \phi(1) + \cdots + \left( A(\left\lfloor x \right\rfloor ) - A(\left\lfloor x \right\rfloor -1) \right) \phi(\left\lfloor x \right\rfloor )\\
    & = -A(1)\phi(1) + \left( \phi(1) - \phi(2) \right) A (2) + \cdots +
\end{align*}
\end{proof}
